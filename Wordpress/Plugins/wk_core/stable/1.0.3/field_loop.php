...
foreach ($fields as $val) {
	...
	if ($type == 'textfield') {
		...
		<a href="/wp-content/plugins/wk_core/types/photo_over/photo.php?<?php echo $params; ?>" title="<?php echo $translation; ?>" class="greybox" id="<?php echo $name; ?>"><? echo $translation; ?></a>
