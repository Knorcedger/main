 ...
 * 
 * PHOTO_OVER, the params are -> level|type|name|translation|default|Button text|width|height|size|thumb~thumbwidth~thumbheight~cropratio -> 1|photo_over|avatar|Photo||Upload|1000|1000|300|1~80~80~1:1
