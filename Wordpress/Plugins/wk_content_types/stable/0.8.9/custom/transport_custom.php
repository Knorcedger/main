<div class="dates-fun">
	...
	?>
		...
		if($dates_num != ''){
			include_once $_SERVER['DOCUMENT_ROOT'] . '/wp-content/plugins/wk_content_types/custom/transport_dates.php';
		?>
...
<div class="dates-display" style="display:none;">
	<div class="all-dates">
		<div class="a-date headers">Αναχώρηση - Επιστροφή - Θέσεις</div>
	</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$(".editdates").click(function(){
			...
			$(".all-dates").empty();
			//add titles again
			$('<div class="a-date headers">Αναχώρηση - Επιστροφή - Θέσεις</div>').appendTo(".all-dates");
		});
