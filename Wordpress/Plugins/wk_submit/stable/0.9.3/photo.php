...
if(get_post_meta($next_post_id, $name, true) != ''){
	...
	if($status != ''){
		...
		//include options
		include 'options.php';
		$thumb_url = "/wp-content/plugins/wk_submit/image.php/".$filename[4]."/?width=".$thumb_width."&height=".$thumb_height."&image=".$full_filename."&cropratio=".$cropratio."&nocache&docroot=".$docroot;
