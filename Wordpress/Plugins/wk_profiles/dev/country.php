...
function wk_edit_profile_country($name, $translation) {
	global $current_user;
?>
<p class="<?php echo $name; ?>">
	<label for="<?php echo $name; ?>"><?php echo $translation; ?>: </label>
	<SELECT NAME="<?php echo $name; ?>">
		<option VALUE="<?php echo $current_user->country; ?>"><?php echo $current_user->country; ?></option>
		...
		<option value="British India">British Indian Ocean Territory</option>
		...
		<option value="Kitts">Saint Kitts and Nevis</option>
		<option value="Saint Lucia">Saint Lucia</option>
		<option value="Vincent">Saint Vincent and the Grenadines</option>
		...
		<option value="Pierre">St. Pierre and Miquelon</option>
		...
		<option value="Caicos">Turks and Caicos Islands</option>
