...
function wk_core_date($level, $name, $translation, $default, $language, $object_id = '', $object_type = 'post'){
	...
	if(check_user_level($level)){ ?>
		<p class="<?php echo $name; ?>">
			<label for="<?php echo $name; ?>_day"><?php echo $day_txt; ?>: </label>
			...
			<label for="<?php echo $name; ?>_month"><?php echo $month_txt; ?>: </label>
			...
			<label for="<?php echo $name; ?>_year"><?php echo $year_txt; ?>: </label>
