 ...
 * AUTOCOMPLETE, the params are -> level|type|name|translation|default|size|query|search_field -> 1|autocomplete|ac_test|Autocomplete||30|SELECT ID, post_title FROM wp_posts WHERE post_author = 1|post_title
 * AUTOCOMPLETE for content_type -> 3|autocomplete|review_company|Company||30||post_title~company
 * 
